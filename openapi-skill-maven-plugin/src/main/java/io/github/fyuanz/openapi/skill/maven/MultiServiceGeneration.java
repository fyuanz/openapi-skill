...
import io.github.fyuanz.openapi.skill.core.AggregateSkillGenerator;
...
final class MultiServiceGeneration {
    ...
    private ServiceSkillUpdater.UpdateResult publish(String id, String name, Callable<Map<String, String>> generation) {
        ...
        String message = "OpenAPI Skill [" + id + "] " + result.outcome() + ": " + result.message() + "; Skill=" + result.skillDirectory();

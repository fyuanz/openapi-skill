# @fyuanz/smartdoc-agent

Generate one Codex Skill from multiple OpenAPI 3.1.0 JSON endpoints. The package is written in TypeScript and can be used as a Vue 3 project's development dependency or as a library.
...
Create `smartdoc-agent.config.json` in the Vue project root:
...
Add a script and run it after the local API service starts:

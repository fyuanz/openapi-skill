...
import { ProjectServiceInput, ResolvedSmartDocConfig, RunOptions, RunResult } from './types.js';
...
export type {
  DocumentSource, GenerateOptions, GenerateProjectOptions, LegacySmartDocConfig,
  ProjectServiceInput, ProjectSmartDocConfig, ResolvedDocumentSource,
  ResolvedServiceSource, ResolvedSmartDocConfig, RunOptions, RunResult,
  ServiceSource, SmartDocConfig, SourceType
} from './types.js';
...
async function downloadServices(config: ResolvedSmartDocConfig): Promise<ProjectServiceInput[]> {
